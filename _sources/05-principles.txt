...
From these principles we derive the following technical choices:

* **TUK - The URL is King**
   Though we like REST, lack of support in existing tools drive us to embrace TUK instead.
   The most severe consequences is that URLs identify representations of entities and not identify the entity itself.
