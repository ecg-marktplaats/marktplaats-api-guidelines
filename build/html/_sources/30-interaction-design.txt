...
:ref:`body parameter <body-parameter>`
...
Clients that do not support the ``PUT`` method may use the :ref:`method-parameter <method-parameter>`
...
to `RFC 6902 <http://tools.ietf.org/html/rfc6902>`_.
...
Clients that do not support the ``PATCH`` method may use the :ref:`method-parameter <method-parameter>`.
...
Clients that do not support the ``DELETE`` method may use the :ref:`method-parameter <method-parameter>`.
